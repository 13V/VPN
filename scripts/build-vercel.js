...
for (const name of ['app.js', 'style.css']) fs.rmSync(path.join(output, name), { force: true });
for (const name of ['landing.css', 'landing.js', 'access.css', 'brand.css', 'connection-sculpture.jpg', 'velora-logo.svg', 'velora-logo-light.svg', 'velora-mark.svg', 'favicon.svg', 'icons.svg', 'manrope-latin.woff2', 'instrument-serif-italic.woff2']) {
