...
for (const name of ['app.js', 'style.css', 'instrument-serif-italic.woff2', 'newsreader-italic.woff2']) fs.rmSync(path.join(output, name), { force: true });
for (const name of ['landing.css', 'landing.js', 'hero-sculpture.js', 'hero-sculpture-fallback.svg', 'threejs-license.txt', 'access.css', 'brand.css', 'connection-sculpture.jpg', 'velora-logo.svg', 'velora-logo-light.svg', 'velora-mark.svg', 'favicon.svg', 'icons.svg', 'manrope-latin.woff2', 'newsreader-roman.woff2']) {
